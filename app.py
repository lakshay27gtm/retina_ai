...
# Define model path
MODEL_PATH = "retina_efficientnet_final.pth"

# Check if model file exists before attempting to load
if not os.path.exists(MODEL_PATH):
    raise FileNotFoundError(f"Model file not found at {MODEL_PATH}. Please ensure it's uploaded to your Hugging Face Space.")
...
# Using map_location='cpu' for broader compatibility on Hugging Face Spaces
